...
public class IdentifiableEntityFilterJsonMessageBodyWriter implements MessageBodyReader<IdentifiableEntityFilter>, MessageBodyWriter<IdentifiableEntityFilter> {
	...
	public boolean isReadable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
		return IdentifiableEntityFilter.class.isAssignableFrom(getDomainClass(genericType));
	}

	public IdentifiableEntityFilter readFrom(Class<IdentifiableEntityFilter> type, Type genericType, Annotation[] annotations, MediaType mediaType, MultivaluedMap<String, String> httpHeaders, InputStream entityStream) throws IOException, WebApplicationException {
		try {
			@SuppressWarnings("unchecked")
			final Class<IdentifiableEntityFilter> domainClass = (Class<IdentifiableEntityFilter>) getDomainClass(genericType);
	...
	public void writeTo(IdentifiableEntityFilter object, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType, MultivaluedMap<String, Object> httpHeaders, OutputStream entityStream) throws IOException, WebApplicationException {
		try {
	...
	public long getSize(UserFilter t, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
		return -1;
	}
